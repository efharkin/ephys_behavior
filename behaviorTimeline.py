...
ephysDates = [datetime.datetime.strptime(d,'%m%d%Y') for d in ephysDates]
...
for i,(prm,lbl) in enumerate(zip((rewardsEarned,lastEngaged,probEngaged),('Rewards Earned','Last Engaged (s)','Probability Engaged'))):
